...
gladiator = media.Movie("Gladiator",
                        "A slave who defited the emperor of Rome",
...
shawshank_redemption = media.Movie("Shawshank redemption",
                        "the story of banker Andy Dufresne (Tim Robbins), who is sentenced to life in Shawshank State Penitentiary for the murder of his wife and her lover, despite his claims of innocence",
...
#call function open_movies_page() which will take in the list movies and generate an HTML file including this content, producing a website to showcase the movies.
